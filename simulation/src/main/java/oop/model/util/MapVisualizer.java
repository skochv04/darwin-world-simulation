    ...
    private String drawObject(Vector2d currentPosition) {
        ...
        if (this.map.isOccupied(currentPosition)) {
            if (this.map.grassAt(currentPosition) != null) {
                cellBuilder.append(this.map.grassAt(currentPosition).toString());
            }

            if (this.map.animalsAt(currentPosition) != null) {
                map.animalsAt(currentPosition).forEach(animal -> cellBuilder.append(animal.toString()));
            }
